  ...
  const festivals: Festival[] = [
    {
      ...
      duration: '3 days',
      description:
        'The most popular religious festival in Bhutan, attracting thousands of locals and visitors to witness sacred Cham dances performed by monks and laymen in vibrant costumes and masks.',
      significance:
    ...
    },
    {
      ...
      duration: '5 days',
      description:
        'One of Bhutan’s most famous and spectacular religious festivals, drawing large crowds of locals and visitors to witness sacred Cham dances and religious rituals.',
      significance:
    ...
    },
    {
      ...
      duration: '2 days',
      description:
        'A vibrant celebration of Bhutanese nomadic culture in the pristine Haa Valley. The festival showcases the unique lifestyle, traditions, and hospitality of the semi-nomadic herders of Haa.',
      significance:
    ...
    },
    {
      ...
      duration: '2 days',
      description:
        'A community-based eco-festival held at the foot of the sacred Mount Jomolhari. It celebrates the culture of highland communities and raises awareness about the conservation of the endangered snow leopard.',
      significance:
    ...
    },
    {
      ...
      duration: '2 days',
      description:
        'A unique festival dedicated to the prized wild Matsutake mushroom. It celebrates the harmony between people and nature through food, culture, and local traditions in the scenic Ura Valley.',
      significance:
    ...
    },
    {
      ...
      duration: '1 day',
      description:
        'A vibrant festival dedicated to the endangered black-necked cranes that migrate to Bhutan each winter. The festival combines conservation awareness with cultural performances, attracting locals, monks, and visitors alike.',
      significance:
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-12 text-center">
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Bhutanese festivals, known as Tsechus, are the most vibrant expressions of the kingdom&apos;s spiritual
            and cultural heritage. These sacred celebrations offer visitors a unique window into the soul of Bhutan,
            where ancient traditions come alive through masked dances, colorful ceremonies, and community gatherings.
          </p>
        </section>
              ...
              <div className={`grid lg:grid-cols-2 gap-0 ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
                ...
                <div className="relative h-64 lg:h-auto">
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    <Badge className="bg-accent text-accent-foreground mb-2">{festival.typicalMonth}</Badge>
